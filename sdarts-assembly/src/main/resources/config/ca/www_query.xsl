                 ...
                 <xsl:for-each select=".//starts:value">
					<xsl:choose>
						<xsl:when test="string(../starts:field/@name)='author'">
							<xsl:choose>
								<xsl:when test="position()=last()">
									<xsl:value-of select="concat(normalize-space(.),'[au] AND CA Cancer J Clin [Journal:__jrid2683]')"/>
								</xsl:when>
								<xsl:otherwise>
						...
						<xsl:when test="string(../starts:field/@name)='mesh-term'">
							<xsl:choose>
								<xsl:when test="position()=last()">
									<xsl:value-of select="concat(normalize-space(.),'[MH] AND CA Cancer J Clin [Journal:__jrid2683]')"/>
								</xsl:when>
								<xsl:otherwise>
						...
						<xsl:when test="string(../starts:field/@name)='title' ">
							<xsl:choose>
								<xsl:when test="position()=last()">
									<xsl:value-of select="concat(normalize-space(.),'[TI] AND CA Cancer J Clin [Journal:__jrid2683]')"/>
								</xsl:when>
								<xsl:otherwise>
						...
						<xsl:when test="string(../starts:field/@name)='title-abstract' ">
							<xsl:choose>
								<xsl:when test="position()=last()">
									<xsl:value-of select="concat(normalize-space(.),'[TIAB] AND CA Cancer J Clin [Journal:__jrid2683]')"/>
								</xsl:when>
								<xsl:otherwise>
						...
						<xsl:when test="string(../starts:field/@name)='journal-title' ">
							<xsl:choose>
								<xsl:when test="position()=last()">
									<xsl:value-of select="concat(normalize-space(.),'[TA] AND CA Cancer J Clin [Journal:__jrid2683]')"/>
								</xsl:when>
								<xsl:otherwise>
						...
						<xsl:when test="string(../starts:field/@name)='publication-type' ">
							<xsl:choose>
								<xsl:when test="position()=last()">
									<xsl:value-of select="concat(normalize-space(.),'[PT] AND CA Cancer J Clin [Journal:__jrid2683]')"/>
								</xsl:when>
								<xsl:otherwise>
						...
						<xsl:when test="string(../starts:field/@name)='mesh-major-topic' ">
							<xsl:choose>
								<xsl:when test="position()=last()">
									<xsl:value-of select="concat(normalize-space(.),'[MAJR] AND CA Cancer J Clin [Journal:__jrid2683]')"/>
								</xsl:when>
								<xsl:otherwise>
						...
						<xsl:when test="string(../starts:field/@name)='mesh-subheading' ">
							<xsl:choose>
								<xsl:when test="position()=last()">
									<xsl:value-of select="concat(normalize-space(.),'[SH] AND CA Cancer J Clin [Journal:__jrid2683]')"/>
								</xsl:when>
								<xsl:otherwise>
						...
						<xsl:when test="string(../starts:field/@name)='mesh-with-subheading' ">
							<xsl:choose>
								<xsl:when test="position()=last()">
									<xsl:value-of select="concat(normalize-space(.), ' AND CA Cancer J Clin [Journal:__jrid2683]')"/>
								</xsl:when>
								<xsl:otherwise>
