...
<!-- to query the Cardiovascular Institute of the South search engine -->
...
<xsl:template match="starts:squery">
	<starts:script>
      ...
      <xsl:text>http://www.harrisonsonline.com/cgi-bin/search_simple.cgi</xsl:text>
		</starts:url>

    <starts:variable>
      <starts:name>book</starts:name>
      <starts:value>harrisons</starts:value>
    </starts:variable>

    <starts:variable>
      <starts:name>searchwhat</starts:name>
      <starts:value>on</starts:value>
    </starts:variable>

    <starts:variable>
      <starts:name>category</starts:name>
      <starts:value>chapters_updates</starts:value>
    </starts:variable>

    <starts:variable>
      <starts:name>category</starts:name>
      <starts:value>tables_figures</starts:value>
    </starts:variable>

    <starts:variable>
      <starts:name>category</starts:name>
      <starts:value>related_sites</starts:value>
    </starts:variable>
    ...
    <starts:variable>
      <starts:name>QueryText</starts:name>
      <starts:value>
