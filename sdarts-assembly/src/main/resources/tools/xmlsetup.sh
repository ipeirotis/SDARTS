...
# sdarts.backend.impls.xml.XMLBackEndLSP framework. This is a wrapper for
# unindexed, XML document collections.
#
...
# parameter
#
# Usage: xmlsetup.sh -name <name_of_BackEndLSP>
